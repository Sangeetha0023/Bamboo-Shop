...
if(isset($register))
{
 if(trim($name)=="") { $msg = "Enter the Name..."; }
	...
	$rdate=date("Y-m-d");
$pass=md5($pwd);
		$uqry="insert into register(id,name,gender,address,pincode,contact,email,bank_name,acc_no,username,password,rdate) values($id,'$name','$gender','$address','$pincode',$contact,'$email','$bank_name','$acc_no','$uname','$pass','$rdate')";
